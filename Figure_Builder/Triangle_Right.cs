...
{
    internal class Triangle_Right : Triangle
    {
        public override FigureSubType subType { get { return FigureSubType.Прямокутний; } }
        public override string color { get; set; }
        public override double Area { get { return Math.Round(area(sideA, sideB, sideC), 3); } }

        // Default constructor
        public Triangle_Right() { }
        //Constructor with parameters
        public Triangle_Right(int w, int h, double A, double B, double C, string color)
        {
            width = w;
            height = h;
            sideA = A;
        ...
        // Copy constructor
        public Triangle_Right(Triangle_Right other)
        {
            if (other == null) 
            {

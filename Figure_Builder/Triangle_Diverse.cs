...
{
    internal class Triangle_Diverse : Triangle
    {
        public override FigureSubType subType { get { return FigureSubType.Різносторонній; } }
        public override string color { get; set; }
        public override double Area { get { return Math.Round(area(sideA, sideB, sideC), 3); } }

        // Default constructor
        public Triangle_Diverse() { }
        //Constructor with parameters
        public Triangle_Diverse(int w, int h, double A, double B, double C, string color)
        {
            width = w; 
            height = h;
            sideA = A;
        ...
        // Copy constructor
        public Triangle_Diverse(Triangle_Diverse other)
        {
            if (other == null)
            {
